...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=104](https://www.apishop.net/#/api/detail/?productID=104) 申请API服务**

**该产品拥有以下APIs：**
1. 计算BMI值
2. 获取标准体重参考
	
本文档提供 **标准体重计算器** 的API调用代码示例,具体请查看code文件夹。
