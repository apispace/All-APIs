...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=83](https://www.apishop.net/#/api/detail/?productID=83) 申请API服务**
...
本文档提供 **实时空气质量数据查询** 的API调用代码示例,具体请查看code文件夹。
