...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/air/getStationList";
$headers = NULL;
$params = array(		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/air/getAirQualityByCity";
$headers = NULL;
$params = array(			
		"city"=>"" //城市名，如：广州市		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/air/getStationAirQuality";
$headers = NULL;
$params = array(			
		"stationCode"=>"" //站点编码从获取站点列表 接口获得		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/air/getNearestStationAirQuality";
$headers = NULL;
$params = array(			
		"latitude"=>"" //纬度			
		"longitude"=>"" //经度		
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/air/getStationIAQI";
$headers = NULL;
$params = array(			
		"stationCode"=>"" //站点编码：从获取站点列表 接口获得		
);
