...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=83](https://www.apishop.net/#/api/detail/?productID=83 "https://www.apishop.net/#/api/detail/?productID=83") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/air/getStationList";
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/air/getAirQualityByCity";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("city", ""); //城市名，如：广州市		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/air/getStationAirQuality";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("stationCode", ""); //站点编码从获取站点列表 接口获得		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/air/getNearestStationAirQuality";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("latitude", ""); //纬度			
			param.Add("longitude", ""); //经度		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/air/getStationIAQI";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("stationCode", ""); //站点编码：从获取站点列表 接口获得		
