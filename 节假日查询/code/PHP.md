...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=90](https://www.apishop.net/#/api/detail/?productID=90 "https://www.apishop.net/#/api/detail/?productID=90") 申请API服务**
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/calendar/queryHoliday";
$headers = NULL;
$params = array(		
);
