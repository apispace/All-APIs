...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/postcode/queryCodeByAddr";
$headers = NULL;
$params = array(			
		"province"=>"" //省份（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）			
		"city"=>"" //城市（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）			
		"area"=>"" //区/县（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/postcode/queryAddrByAreaCode";
$headers = NULL;
$params = array(			
		"areaCode"=>"" //区号		
);
