...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=106](https://www.apishop.net/#/api/detail/?productID=106 "https://www.apishop.net/#/api/detail/?productID=106") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/postcode/queryCodeByAddr";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("province", ""); //省份（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）			
			param.Add("city", ""); //城市（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）			
			param.Add("area", ""); //区/县（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/postcode/queryAddrByAreaCode";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("areaCode", ""); //区号		
