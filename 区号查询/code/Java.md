...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("province", ""); //省份（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）			
		params.put("city", ""); //城市（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）			
		params.put("area", ""); //区/县（省份、城市、区/县必须三选一输入，默认以最小单位进行查询）		
		String result = null;
		try
		{
