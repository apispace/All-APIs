...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("classID", ""); //成语类别ID（1：字谜；2：动物谜语；3：灯谜；4：物品谜语；5：儿童谜语；6：植物谜语；7：趣味谜语；8：数字谜语；9：搞笑谜语；10：经典谜语；11：成语谜语），如“1”			
		params.put("keyWord", ""); //关键字，如“鸡”，为空则随机获取			
		params.put("pageNum", ""); //页码，如“1”，默认第一页			
		params.put("pageSize", ""); //每页条数，如“1”，最大为2		
		String result = null;
		try
		{
