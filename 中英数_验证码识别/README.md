...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=110](https://www.apishop.net/#/api/detail/?productID=110) 申请API服务**

**该产品拥有以下APIs：**
1. 识别中英数验证码
	
本文档提供 **中英数_验证码识别** 的API调用代码示例,具体请查看code文件夹。
