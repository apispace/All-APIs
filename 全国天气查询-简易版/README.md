...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=130](https://www.apishop.net/#/api/detail/?productID=130) 申请API服务**

**该产品拥有以下APIs：**
1. 查询天气实况
2. 查询未来3天的天气预报
	
本文档提供 **全国天气查询-简易版** 的API调用代码示例,具体请查看code文件夹。
