...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/aphorism/queryAphorismTitleList";
$headers = NULL;
$params = array(			
		"type"=>"" //类型（1:励志名言;2:人生格言;3:名言警句;4:名人名言;5:读书名言;6:经典名言;7:爱情名言;8:名言佳句）		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/aphorism/getAphorismList";
$headers = NULL;
$params = array(			
		"titleID"=>"" //标题ID（从获取标题接口列表获得）		
);
