...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=123](https://www.apishop.net/#/api/detail/?productID=123 "https://www.apishop.net/#/api/detail/?productID=123") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/aphorism/queryAphorismTitleList";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("type", ""); //类型（1:励志名言;2:人生格言;3:名言警句;4:名人名言;5:读书名言;6:经典名言;7:爱情名言;8:名言佳句）		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/aphorism/getAphorismList";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("titleID", ""); //标题ID（从获取标题接口列表获得）		
