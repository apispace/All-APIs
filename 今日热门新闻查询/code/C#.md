...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/news/getNewsChannel";
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/news/getNews";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("channel", ""); //新闻频道,如"头条"			
			param.Add("num", ""); //数量,最大40，默认10			
			param.Add("start", ""); //开始位置,默认为0		
