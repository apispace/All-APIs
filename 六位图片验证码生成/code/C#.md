...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/verify/getComplicateVerifyImage";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("codeType", ""); //验证码类型(1:纯数字,2:小写字母,3:大写字母,4:数字+小写字母,5:数字+大写字母,6:数字+大小写字母,7:大小写字母)		
