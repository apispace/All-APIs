...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=101](https://www.apishop.net/#/api/detail/?productID=101) 申请API服务**

**该产品拥有以下APIs：**
1. 获取6位图片验证码
	
本文档提供 **六位图片验证码生成** 的API调用代码示例,具体请查看code文件夹。
