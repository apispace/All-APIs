...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=98](https://www.apishop.net/#/api/detail/?productID=98 "https://www.apishop.net/#/api/detail/?productID=98") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/dictionary/queryChineseWord";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("word", ""); //要查询的字,如“口”		
