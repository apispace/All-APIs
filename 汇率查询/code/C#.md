...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=84](https://www.apishop.net/#/api/detail/?productID=84 "https://www.apishop.net/#/api/detail/?productID=84") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/exchange/getAllCurrency";
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/exchange/convertExchange";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("amount", ""); //数量			
			param.Add("from", ""); //要换算的单位（获取所有货币种类接口中获取）			
			param.Add("to", ""); //换算后的单位（获取所有货币种类接口中获取）		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/exchange/getExchangeByCurrency";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("currency", ""); //货币（获取所有货币种类接口中获取）		
