...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=117](https://www.apishop.net/#/api/detail/?productID=117 "https://www.apishop.net/#/api/detail/?productID=117") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/car/queryCarBrand";
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/car/queryCarList";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("brandID", ""); //品牌ID(从获取品牌接口获取)		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/car/queryCarDetail";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("carID", ""); //车型ID(从获取车型接口查询)		
