...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/car/queryCarBrand";
$headers = NULL;
$params = array(		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/car/queryCarList";
$headers = NULL;
$params = array(			
		"brandID"=>"" //品牌ID(从获取品牌接口获取)		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/car/queryCarDetail";
$headers = NULL;
$params = array(			
		"carID"=>"" //车型ID(从获取车型接口查询)		
);
