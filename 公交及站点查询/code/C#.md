...
#### 公交及站点查询
获取公交线路信息，提供了包括根据站点查询线路、根据公交查询线路等方式。
...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=77](https://www.apishop.net/#/api/detail/?productID=77 "https://www.apishop.net/#/api/detail/?productID=77") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/bus/queryBusLine";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("city", ""); //城市名称，如“广州”			
			param.Add("busNo", ""); //公交线路，如“86路”		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/bus/queryBusStation";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("city", ""); //城市名称，如“广州”			
			param.Add("station", ""); //站点名称，如“综合商业南区”（注：不加“站”字）		
