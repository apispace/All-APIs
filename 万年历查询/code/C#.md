...
#### 万年历查询
查询指定日期的星期、星座、农历、生肖、天干地支、岁次、黄历相关的福神、喜神、宜忌等信息，还可以进行阴阳历转换。

#### 该产品拥有以下APIs：
1. 万年历查询

**注意，该示例代码仅适用于 [www.apishop.net](www.apishop.net "www.apishop.net") 网站下API**
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=89](https://www.apishop.net/#/api/detail/?productID=89 "https://www.apishop.net/#/api/detail/?productID=89") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/calendar/queryCalendar";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("date", ""); //要查询的日期，格式：YYYY-mm-dd		
