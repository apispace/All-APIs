...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("codeType", ""); //验证码类型 1001: 数字+字母类型， 1002: 纯英文类型，1003: 纯数字类型，1004:计算题类型（使用multipart/form-data方式请求）			
		params.put("length", ""); //验证码长度（使用multipart/form-data方式请求）			
		params.put("image", ""); //验证码图片，图片大小需要小于100KB（使用multipart/form-data方式请求）		
		String result = null;
		try
		{
