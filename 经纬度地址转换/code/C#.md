...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=78](https://www.apishop.net/#/api/detail/?productID=78 "https://www.apishop.net/#/api/detail/?productID=78") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/exchange/exchangeAddrByLatLng";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("latitude", ""); //纬度			
			param.Add("longitude", ""); //经度			
			param.Add("dataType", ""); //经纬度来源：baidu代表百度地图，google代表谷歌地图		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/exchange/exchangeLatLngByAddr";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("address", ""); //地址			
			param.Add("dataType", ""); //经纬度来源：baidu代表百度地图，google代表谷歌地图		
