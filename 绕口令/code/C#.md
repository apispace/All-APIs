...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=127](https://www.apishop.net/#/api/detail/?productID=127 "https://www.apishop.net/#/api/detail/?productID=127") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/tongue/getTongueListByRandom";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("pageSize", ""); //获取条数（最多15条，默认10）		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/tongue/getTongueList";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("page", ""); //页码			
			param.Add("pageSize", ""); //获取条数（最多15条，默认10）		
