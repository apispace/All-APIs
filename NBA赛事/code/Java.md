...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=125](https://www.apishop.net/#/api/detail/?productID=125 "https://www.apishop.net/#/api/detail/?productID=125") 申请API服务**
...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("year", ""); //年份（范围：2014~2017）			
		params.put("page", ""); //页码			
		params.put("pageSize", ""); //每页条数（最多40，默认20条）		
		String result = null;
		try
		{
...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		String requestMethod = "POST";
		Map<String, String> params = new HashMap<String, String>();			
		params.put("team1", ""); //客队球队名称（如“火箭”）			
		params.put("team2", ""); //主队球队名称（如“马刺”）			
		params.put("page", ""); //页码			
		params.put("pageSize", ""); //每页条数（最多40，默认20条）		
		String result = null;
		try
