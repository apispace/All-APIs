...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("date", ""); //日期，格式：YYYY-mm-dd			
		params.put("startStation", ""); //起始站，如“广州南”(不需要加上站字)			
		params.put("endStation", ""); //终点站，如“普宁”(不需要加上站字)		
		String result = null;
		try
		{
...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		String requestMethod = "POST";
		Map<String, String> params = new HashMap<String, String>();			
		params.put("trainNo", ""); //车次编号，如“G6313”		
		String result = null;
		try
		{
			InputStream is = httpRequestToStream(url, requestMethod, params);
...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		String requestMethod = "POST";
		Map<String, String> params = new HashMap<String, String>();			
		params.put("isHigh", ""); //是否高铁：0代表否，1代表是			
		params.put("startStation", ""); //起始站，如“广州南”(不需要加上站字)			
		params.put("endStation", ""); //终点站，如“广州南”(不需要加上站字)		
		String result = null;
		try
		{
			InputStream is = httpRequestToStream(url, requestMethod, params);
