...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/train/getLeftTicket";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("date", ""); //日期，格式：YYYY-mm-dd			
			param.Add("startStation", ""); //起始站，如“广州南”(不需要加上站字)			
			param.Add("endStation", ""); //终点站，如“普宁”(不需要加上站字)		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/train/queryTrainLineInfo";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("trainNo", ""); //车次编号，如“G6313”		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/train/queryTicket";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("isHigh", ""); //是否高铁：0代表否，1代表是			
			param.Add("startStation", ""); //起始站，如“广州南”(不需要加上站字)			
			param.Add("endStation", ""); //终点站，如“广州南”(不需要加上站字)		
