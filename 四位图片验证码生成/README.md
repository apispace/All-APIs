...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=102](https://www.apishop.net/#/api/detail/?productID=102) 申请API服务**

**该产品拥有以下APIs：**
1. 获取四位图片验证码
	
本文档提供 **四位图片验证码生成** 的API调用代码示例,具体请查看code文件夹。
