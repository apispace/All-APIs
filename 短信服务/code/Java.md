...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("phoneNum", ""); //目标手机号（运营商限制同一手机号一天发送不得超过10条，特殊需求请与我们联系）			
		params.put("templateID", ""); //短信模板ID，短信模版审核通过后即生效			
		params.put("params", ""); //短信变量字段json数组，用于替换短信模板中的@字符，长度最大20，如短信模板里有2个变量，分别用123和abc替换，那么该参数的示例为[123,"abc"]		
		String result = null;
		try
		{
