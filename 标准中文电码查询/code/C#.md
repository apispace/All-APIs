...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=96](https://www.apishop.net/#/api/detail/?productID=96 "https://www.apishop.net/#/api/detail/?productID=96") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/code/convertChineseToCode";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("chinese", ""); //中文内容,如“你好”		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/code/convertCodeToChinese";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("code", ""); //电码内容，用英文逗号分割,如“0132,1170”		
