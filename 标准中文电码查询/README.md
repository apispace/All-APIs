...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=96](https://www.apishop.net/#/api/detail/?productID=96) 申请API服务**

**该产品拥有以下APIs：**
1. 中文转电码
2. 电码转中文
	
本文档提供 **标准中文电码查询** 的API调用代码示例,具体请查看code文件夹。
