...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=124](https://www.apishop.net/#/api/detail/?productID=124 "https://www.apishop.net/#/api/detail/?productID=124") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/aphorism/queryEnglishAphorismTitleList";
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/aphorism/getEnglishAphorismList";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("titleID", ""); //标题ID（从获取英语名言标题列表接口获得）		
