...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/aphorism/queryEnglishAphorismTitleList";
$headers = NULL;
$params = array(		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/aphorism/getEnglishAphorismList";
$headers = NULL;
$params = array(			
		"titleID"=>"" //标题ID（从获取英语名言标题列表接口获得）		
);
