...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=113](https://www.apishop.net/#/api/detail/?productID=113) 申请API服务**

**该产品拥有以下APIs：**
1. 查询电信基站信息
	
本文档提供 **电信基站查询** 的API调用代码示例,具体请查看code文件夹。
