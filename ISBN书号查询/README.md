...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=79](https://www.apishop.net/#/api/detail/?productID=79) 申请API服务**

**该产品拥有以下APIs：**
1. ISBN书号查询
	
本文档提供 **ISBN书号查询** 的API调用代码示例,具体请查看code文件夹。
