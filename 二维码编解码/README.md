...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=128](https://www.apishop.net/#/api/detail/?productID=128) 申请API服务**

**该产品拥有以下APIs：**
1. 二维码生成
2. 二维码解码
	
本文档提供 **二维码编解码** 的API调用代码示例,具体请查看code文件夹。
