...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("postcode", ""); //邮编			
		params.put("page", ""); //页数			
		params.put("pageSize", ""); //每页行数		
		String result = null;
		try
		{
...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		String requestMethod = "POST";
		Map<String, String> params = new HashMap<String, String>();			
		params.put("province", ""); //省份（省份、城市、区/县、地址关键字必须四选一输入）			
		params.put("city", ""); //城市（省份、城市、区/县、地址关键字必须四选一输入）			
		params.put("area", ""); //区/县（省份、城市、区/县、地址关键字必须四选一输入）			
		params.put("address", ""); //地名关键字，如“一路”（省份、城市、区/县、地址关键字必须四选一输入）			
		params.put("page", ""); //页码，默认第一页			
		params.put("pageSize", ""); //每页条数，默认10条，最多40条		
		String result = null;
		try
		{
			InputStream is = httpRequestToStream(url, requestMethod, params);
