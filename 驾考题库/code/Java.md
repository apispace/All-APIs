...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		params.put("subject", ""); //选择考试科目类型：1为科目一；2为科目二；3为科目三；4为科目四			
		params.put("model", ""); //驾照类型,有c1、c2、b1、b2、a1、a2，当subject=4时可省略			
		params.put("testType", ""); //测试类型：rand代表随机测试（随机100个题目）；order代表顺序测试（所选科目全部题目）		
		String result = null;
		try
		{
