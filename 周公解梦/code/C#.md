...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/dream/getDreamTypes";
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/dream/queryDreamDetailByType";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("type", ""); //梦的类型（从获取梦的类型接口获得）			
			param.Add("page", ""); //页码			
			param.Add("pageSize", ""); //每页条数（最多20条，默认10）		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/dream/searchDreamDetail";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("keyword", ""); //关键字		
