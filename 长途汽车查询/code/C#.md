...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=100](https://www.apishop.net/#/api/detail/?productID=100 "https://www.apishop.net/#/api/detail/?productID=100") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/coach/queryCoachStation";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("city", ""); //城市,如“广州”		
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/coach/queryCity2City";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("startCity", ""); //出发城市,如“广州”			
			param.Add("endCity", ""); //终点城市,如“普宁”		
