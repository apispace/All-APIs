...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=100](https://www.apishop.net/#/api/detail/?productID=100) 申请API服务**

**该产品拥有以下APIs：**
1. 长途汽车站查询
2. 长途汽车时刻查询
	
本文档提供 **长途汽车查询** 的API调用代码示例,具体请查看code文件夹。
