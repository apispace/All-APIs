...
public class Api
{
	...
	public static void main(String args[])
    {
		...
		String requestMethod = "POST";
		Map<String, String> params = new HashMap<String, String>();			
		params.put("page", ""); //页码，默认第一页			
		params.put("pageSize", ""); //每页条数（最大20）			
		params.put("updateTime", ""); //更新时间（不填从最早的数据开始），时间格式“2017-08-31 00:00:00”			
		params.put("delay", ""); //数据的更新日期相对于updateTime（1：before[之前]，2：after[之后]）		
		String result = null;
		try
		{
			InputStream is = httpRequestToStream(url, requestMethod, params);
