...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/joke/getJokesByRandom";
$headers = NULL;
$params = array(			
		"pageSize"=>"" //获取条数（最大20）		
);
...
<?php
$method = "POST";
$url = "https://api.apishop.net/common/joke/getJokes";
$headers = NULL;
$params = array(			
		"page"=>"" //页码，默认第一页			
		"pageSize"=>"" //每页条数（最大20）			
		"updateTime"=>"" //更新时间（不填从最早的数据开始），时间格式“2017-08-31 00:00:00”			
		"delay"=>"" //数据的更新日期相对于updateTime（1：before[之前]，2：after[之后]）		
);
