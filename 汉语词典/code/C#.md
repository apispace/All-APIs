...
#### 汉语词典
包括词语的发音、解释、例子、出自、近义词、反义词等数据，包含成语、俗语等。

#### 该产品拥有以下APIs：
1. 汉语词典查询

**注意，该示例代码仅适用于 [www.apishop.net](www.apishop.net "www.apishop.net") 网站下API**
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=99](https://www.apishop.net/#/api/detail/?productID=99 "https://www.apishop.net/#/api/detail/?productID=99") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/dictionary/queryChineseWords";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("words", ""); //要查询的词语,如“生活”		
