...
**使用该产品前，您需要通过 [https://www.apishop.net/#/api/detail/?productID=119](https://www.apishop.net/#/api/detail/?productID=119 "https://www.apishop.net/#/api/detail/?productID=119") 申请API服务**
...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/urls/getTopURL";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("count", ""); //数量(默认为10)			
			param.Add("days", ""); //统计的时间范围，从请求时往前的天数		
