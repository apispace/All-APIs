...
namespace apishop_sdk
{
	class Program
	{
		...
		{
			string method = "POST";
			string url = "https://api.apishop.net/common/verify/verifyURL";
			Dictionary<string, string> param = new Dictionary<string, string>();			
			param.Add("URL", ""); //待验证的url，如“https://apistore.eolinker.com”			
			param.Add("version", ""); //版本（1：原始版本，速度较慢但准确率较高；2：新版本，速度快但准确率低），默认为版本2		
